  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`pointer-events-none absolute inset-y-0 ${dir === "rtl" ? "left-0 -translate-x-4 pl-4 sm:translate-x-0 sm:pl-8" : "right-0 translate-x-4 pr-4 sm:translate-x-0 sm:pr-8"} z-0 hidden items-center transition-transform sm:flex`}
          aria-hidden="true"
        >
